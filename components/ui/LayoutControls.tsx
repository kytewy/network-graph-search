			...
			<div className="space-y-2">
				...
				<div className="flex items-center gap-2">
					<select
						value={currentLayout}
						onChange={(e) => {
							const newLayout = e.target.value as
								| 'forceDirected'
								| 'concentric'
								| 'radial';
				...
				<div className="text-xs text-gray-500 mt-1 italic">
					{currentLayout === 'forceDirected' &&
						'Show me everything and how it relates. Uses physics simulation for natural spacing.'}
					{currentLayout === 'concentric' &&
						'Show me by importance level. Arranges nodes in concentric circles based on level property.'}
					{currentLayout === 'radial' &&
						'Show me everything related to THIS topic. Arranges nodes radiating outward from central points.'}
				</div>
			</div>
