...
import { type Node, type Link, sampleNodes, sampleLinks } from "@/lib/sample-data"
...
interface NetworkState {
  ...
  setLayoutType: (type: "radial" | "tree") => void
...
export const useNetworkStore = create<NetworkState>((set, get) => ({
  ...
  addSelectedNode: (nodeId) =>
    set((state) => ({
      selectedNodes: state.selectedNodes.includes(nodeId) ? state.selectedNodes : [...state.selectedNodes, nodeId],
    })),
