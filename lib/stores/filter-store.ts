...
interface FilterState {
	...
	colorMode: 'sourceType' | 'continent' | 'similarityRange' | 'documentType';
	...
	setColorMode: (
		mode: 'sourceType' | 'continent' | 'similarityRange' | 'documentType'
	) => void;
	setNodeSizeMode: (
...
export const useFilterStore = create<FilterState>((set, get) => ({
	...
	setSelectedStateProvinces: (provinces) =>
		set({ selectedStateProvinces: provinces }),
	setSelectedSourceTypes: (types) => set({ selectedSourceTypes: types }),
	setDeselectedNodeTypes: (types) => set({ deselectedNodeTypes: types }),
	setSelectedSimilarityRange: (range) =>
		set({ selectedSimilarityRange: range }),
	...
	setExpandedContinents: (continents) =>
		set({ expandedContinents: continents }),
	clearFilters: () =>
		set({
			searchTerm: '',
			selectedNodeTypes: [],
